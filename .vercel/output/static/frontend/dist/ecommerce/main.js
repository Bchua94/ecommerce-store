...
var StatsComponent = /** @class */ (function () {
    function StatsComponent(productService, route) {
        ...
        this.route = route;
        this.cards = [
            { title: 'Products', number: 25, icon: 'fas fa-box' },
            { title: 'Categories', number: 10, icon: 'fas fa-tags' },
            { title: 'Users', number: 100, icon: 'fas fa-users' },
            { title: 'Orders', number: 50, icon: 'fas fa-shopping-cart' }
        ];
